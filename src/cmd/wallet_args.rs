...
use crate::config::KEPLER_WALLET_DIR;
use crate::util::file::get_first_line;
use crate::util::{Mutex, ZeroingString};
/// Argument parsing and error handling for wallet commands
use clap::ArgMatches;
use failure::Fail;
use kepler_wallet_config::{TorConfig, WalletConfig};
use kepler_wallet_controller::command;
use kepler_wallet_controller::{Error, ErrorKind};
use kepler_wallet_impls::tor::config::is_tor_address;
use kepler_wallet_impls::{DefaultLCProvider, DefaultWalletImpl};
use kepler_wallet_impls::{PathToSlate, SlateGetter as _};
use kepler_wallet_libwallet::Slate;
use kepler_wallet_libwallet::{IssueInvoiceTxArgs, NodeClient, WalletInst, WalletLCProvider};
use kepler_wallet_util::kepler_core as core;
use kepler_wallet_util::kepler_core::core::amount_to_hr_string;
use kepler_wallet_util::kepler_core::global;
	...
	),
{
	...
	let res = match wallet_args.subcommand() {
		...
		_ => {
			let msg = format!("Unknown wallet command, use 'kepler-wallet help' for details");
